    ...
    return (
        ...
        `}>
            <div className="shrink-0 mb-4 flex justify-center border-b-2 border-[#1BA7D9] pb-2"> 
                <Link href="/expert" className="relative block w-full max-w-48 h-18">
                    <Image
            ...
            {/* Logout */}
            <button className="flex items-center gap-3 px-4 py-3 text-gray-400 font-bold text-sm mt-auto hover:text-red-500 transition-all">
