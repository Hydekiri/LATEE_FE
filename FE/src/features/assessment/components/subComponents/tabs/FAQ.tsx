                        ...
                        <div key={issue.id} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-md hover:border-blue-200 transition-all group flex flex-col">
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <div className="flex items-center gap-4">
                                    {/* Edit/Delete: Chỉ hiện khi chưa có phản hồi[cite: 8] */}
                            ...
                            <div className="space-y-4 pl-1 flex-1">
                                ...
                                {/* Toggle TextArea/Content[cite: 8] */}
                                {actionId === issue.id ? (
                                    <div className="space-y-3 animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        <div className="flex justify-end gap-2">
                                            <button onClick={() => setActionId(null)} className="px-3 py-1.5 text-[10px] font-bold text-gray-400 uppercase hover:bg-gray-100 rounded-lg">Cancel</button>
                                            <button onClick={() => handleSaveEdit(issue.id)} className="px-4 py-1.5 text-[10px] font-bold bg-[#235697] text-white uppercase rounded-lg shadow-md flex items-center gap-1 hover:bg-[#1BA7D9] transition-all">
