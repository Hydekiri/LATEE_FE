    ...
    return (
        <div className="mb-10">
            <div className="flex justify-between items-center">
                <h2 className="text-3xl font-bold text-gray-800 pb-4">Case: #{data.assessmentId}</h2>
            </div>

            <div className="flex items-center gap-8">
                <div className="w-36 h-36 relative rounded-xl overflow-hidden shrink-0 border border-gray-100">
                    <Image src={getImageSrc(data.img)} alt="case thumbnail" fill className="object-cover" />
                </div>
                <div className="flex-1">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-[#2AA8D8] font-bold text-lg">Times practiced: {data.listAttempts?.length || data.timesPracticed || 0}</p>
                    </div>
                </div>
            </div>
        </div>
