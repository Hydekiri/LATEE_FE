...
export const MOCK_ASSESSMENTS: AssessmentData[] = [
    {
        ...
        descriptions: "Explore how clinicians use structured diagnostic thinking to evaluate symptoms, identify chief concerns, analyze patient history, and generate differential diagnoses through interactive virtual scenarios.",
        goal: "Master the clinical reasoning process through structured patient scenarios.", 
